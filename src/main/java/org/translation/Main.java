...
public class Main {
    ...
    public static void runProgram(Translator translator) {
        ...
        while (true) {
            ...
            // LanguageCodeConverter languageConverter = new LanguageCodeConverter(country);
